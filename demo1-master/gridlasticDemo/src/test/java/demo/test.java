	 ...
	 DesiredCapabilities capabilities;
		...
		@Test
		   public void test_site(String test_title, String jenkins_hostname, ITestContext myTestContext) throws Exception  { 	
            driver.get("https://sehar-bbnc-test.concoursehost.com/internationalorderofthemonks ");
			Thread.sleep(100); //slow down for demo purposes
            driver.findElement(By.cssSelector("[id$=donationAmount]")).sendKeys("100");
               driver.findElement(By.cssSelector("[id$=nameFirst]")).sendKeys("Load");
               driver.findElement(By.cssSelector("[id$=nameLast]")).sendKeys("Test");
               driver.findElement(By.cssSelector("[id$=emailAddress]")).sendKeys("selenium@loadTest.com");
               driver.findElement(By.cssSelector("[id$=phoneNumber]")).sendKeys("5555555555");
               driver.findElement(By.cssSelector("[id$=streetAddressInput]")).sendKeys("123 Load Test St");
               driver.findElement(By.cssSelector("[id$=zipCode]")).sendKeys("55555");
               Thread.sleep(100);
               driver.findElement(By.cssSelector("[id$=creditCardNumber]")).sendKeys("4111111111111111");
               driver.findElement(By.cssSelector("[id$=creditCsc]")).sendKeys("111");
               driver.findElement(By.cssSelector("[id$=expirationMonth]")).selectByValue("01");
               driver.findElement(By.cssSelector("[id$=expirationYear]")).selectByValue("2018");
               driver.findElement(By.cssSelector("button[id$=donate]")).click();
	        Thread.sleep(5000);
